...
events = [
    {"name": "День открытых дверей", "date": "25 декабря", "place": "Актовый зал"},
    {"name": "Хакатон для студентов", "date": "30 декабря", "place": "Компьютерный класс"},
    {"name": "Новогодний концерт", "date": "28 декабря", "place": "Актовый зал"},
]
